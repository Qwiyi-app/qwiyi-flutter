              ...
              child: ListTile(
                leading: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: getIt.isChecked ? Icon(Icons.check, color: getIt.isChecked ? kBColor : Colors.white,) : const Text('')
                  ),
                ),
                title: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
            ...
            const Spacer(),
             Row(
              ...
              children: [
                QwiyiButton(
                  width: 130.w,
                  onClick: () => NavigatorRoute.navigateAndRemoveUntilRoute( AddNewAccount()),
                label: 'Add New'),
                addHorizontalSp(20),
                 QwiyiButton(
