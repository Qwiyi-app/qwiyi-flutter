                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index){
                      return Container(
                        ...
                        child: Text(
                              getHistory[index].name.substring(0,1).toUpperCase()
                           ),
                          ),
                     title: Column(
                       ...
                       children: [
                         ...
                         Text(getHistory[index].dateTIme,
                          style: QwiyiTypography.normalPrimaryTextStyle(context)
                         .copyWith(color: primaryColor, fontSize: 12.sp)
                         )
                       ],
                     ),
                     trailing: Text('${usCurrency(context).currencySymbol}' '${getHistory[index].amt}',
                     style: QwiyiTypography.bigTextStyle(context)
                     .copyWith(color: getHistory[index].color,
